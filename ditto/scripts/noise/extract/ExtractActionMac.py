...
class ExtractActionMac:
    """The ExtractActionMac class extracts the commonly found patterns or basic-blocks of instructions from a given directory of executables."""

    def __init__(self, platform, arch, directory):
        """Initiate the ExtractActionMac class.
