 ...
 * @verify    all    amd64    transform_nullifications      hex_not_present                   31C0                             Is `xor, eax, eax` in HEX.
 ...
 * @verify    all    all      all                           returns                           uint8_t,0                        Must be the case without metamorphications.
 */
