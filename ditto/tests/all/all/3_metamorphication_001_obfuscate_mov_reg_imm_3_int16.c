 ...
 * @verify    all    amd64    transform_reg_mov_immediates    hex_not_present                   66B80080               Is `mov eax, 0xffff8000` in HEX.
 * @verify    all    arm64    transform_reg_mov_immediates    hex_not_present                   E0FF8F12               Is `mov w0, #0x8000` in HEX.
