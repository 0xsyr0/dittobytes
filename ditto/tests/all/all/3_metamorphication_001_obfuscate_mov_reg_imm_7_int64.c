 ...
 * @verify    all    amd64    transform_reg_mov_immediates    hex_not_present                   48B80000000000000080                 Is `movabs rax, 0x8000000000000000` in HEX.
 * @verify    all    arm64    transform_reg_mov_immediates    hex_not_present                   0000F0D2                             Is `mov x0, #-0x8000000000000000` in HEX.
