...
<table align=center>
    <tr>
        <td align=center><a href="#3-developing">Developing</a></td>
        <td align=center></td>
        <td align=center colspan=2><a href="#4-compiling">Developing</a></td>
        <td align=center></td>
        <td align=center><a href="#5-outputs">Outputs</a></td>
    </tr>
    <tr>
        <td align=center>
            Edit <code>./code/beacon.c</code><br>
            <sup>Or use <code>./code/examples/</code>.</sup>
        </td>
        <td align=center>→</td>
        <td align=center>
            Run <code>make</code><br>
            <sup>Or <code>make help</code>.</sup>
        </td>
        <td align=left>
            <ol>
                <li>Metamorphications applied</li>
                <li>Position Independence ensured</li>
                <li>Conversion to output format(s)</li>
            </ol>
        </td>
        <td align=center>→</td>
        <td align=left>
            <ul>
                <li>Position Independent Code (<code>.raw</code>)</li>
                <li>Beacon Object File (<code>.obj</code>)</li>
                <li>Clickable/Executable (<code>.exe</code>)</li>
            </ul>
        </td>
    </tr>
</table>
<p align=center><sup>Illustration B: Compilation flow of Dittobytes.</sup></p>
...
<details>
    ...
    <hr>
    <p>Dittobytes was originally designed to output Truly Position Independent Code. Simply put, Truly Position Independent Code, also known as PIC, is executable assembly instructions from the <code>.text</code> segment of an executable binary without any reference to other segments or absolute memory addresses.</p>
    <p>The <code>.raw</code> files are generated for Windows, Linux and MacOS (and both AMD64 and ARM64).</p>
    <hr>
</details>
...
<details>
    ...
    <hr>
    <p>In the process of creating Position Independent Code, Dittobytes creates an <code>.obj</code> file (COFF/ELF) format. This file is later used to extract the <code>.text</code> segment (<code>.raw</code>) or create the executable format (<code>.exe</code>). However, the <code>.obj</code> file itself can be used as Cobalt Strike (or any other C&C framework) Beacon Object File (BOF).</p>
    <p>The <code>.obj</code> files are generated for Windows, Linux and MacOS (and both AMD64 and ARM64).</p>
    <hr>
</details>
...
<details>
    ...
    <p>The <code>.exe</code> files are generated for Windows, Linux and MacOS (and both AMD64 and ARM64).</p>
    <hr>
</details>
